...
trait WhereTrait
{
    ...
    {
        $this->resolveWhere($condition, QueryEnum::OPERATOR_OR, $params);
    ...
    {
        $this->resolveWhere($condition, QueryEnum::OPERATOR_AND, $params);
    ...
    {
        $this->inCondition($field, $data, QueryEnum::OPERATOR_AND );
    ...
    {
        $this->inCondition($field, $data, QueryEnum::OPERATOR_OR );
